...
import bgImageLogo from "../assets/pokemon-logo-png-1446.png";
...
const Register = () => {
  ...
  const { handleRegister } = useAuthor();
  ...
  return (
    ...
    >
      <div className="relative z-10 flex items-start justify-center min-h-screen pt-[200px]">
        <form
        ...
        >
          <img
            src={bgImageLogo}
            alt="Logo Pokémon"
            className="w-24 md:w-32 mx-auto -mt-22 mb-4 relative z-20"
          />
