...
export default function Countries({ hosts, limit = 24 }: CountriesProps) {
  ...
  return (
    <section id="countries" className="mx-auto max-w-6xl px-4 py-10">
      <div className="mb-4 flex items-end justify-between">
        <h2 className="text-xl font-semibold">Countries filtered</h2>
        <Link
