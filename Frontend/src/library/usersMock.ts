...
export const Users: User[] = [
  {
    ...
    pictureURL: "",
    role: "Volunteer",
    skills: ["Cooking", "Farming", "Surf Coaching", "Renovation"],
  ...
  },
  {
    ...
    pictureURL: "",
    role: "Volunteer",
    skills: ["Cooking", "Surf Coaching", "Painting", "Renovation"],
  ...
  // --- Hosts (inside the same array) ---
  {
    ...
    role: "Host",
    pictureURL: "",
    skills: ["Gardening", "Cooking", "Renovation"],
