...
import { registerAuthSchema, loginSchema, userProfileAuthSchema, userSchema, userAuthSchema } from '#schemas';
...
export type UserProfileSchemaDTO = z.infer<typeof userProfileAuthSchema>;
