...
// import type { PostDTO, ErrorResponseDTO } from '../types/types.ts';
// import { AI_API_KEY, AI_URL, AI_MODEL } from '#config';
...
// export const createSimpleChatCompletion: RequestHandler<unknown, ResponseCompletion, IncomingPrompt> = async (
//   req,
//   res
// ) => {
...
// };
// export const createChatCompletion: RequestHandler<unknown, ResponseWithId, IncomingPrompt> = async (req, res) => {
...
//   }
// };
// export const createPersonalizedChatCompletion: RequestHandler<unknown, ResponseWithId, IncomingPrompt> = async (
//   req,
//   res
// ) => {
//   const { prompt, chatId, stream } = req.body;
...
//   } else {
//     res.json({
//       completion: checkIntentCompletionMessage?.content || 'Sorry, something went wrong. Please repeat the question',
